...
<head>
    ...
    #formContainer {
        margin-top: 80px;
        /* Adjust the top margin to add spacing between the header and formContainer */
...
<body>
    <header>
        <nav>
            ...
            <a href="../updatecust/cust_update.php">Update<img src="../../../images/loading-arrow.png" alt="update img"
                    width="20px"></a>
    ...
    <div id="formContainer">
        ...
        <form action="" method="post">
            ...
            <input type="text" name="cust_name" placeholder="Eg:Sahil" required>
            <br><br>

            <label for="email">Email:</label>
            <input type="email" name="email" placeholder="Eg:sh@gmail.com" required>
            <br><br>

            <label for="pass_word">Password:</label>
            <input type="password" name="pass_word" minlength="6" maxlenght="10" placeholder="" required>
            <br><br>

            <label for="phone_number">Phone Number:</label>
            <input type="tel" name="phone_number" maxlength="10" placeholder="Eg:1234567890" required>
            <br><br>
